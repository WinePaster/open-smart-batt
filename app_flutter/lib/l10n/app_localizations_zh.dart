...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get capacitorSelfCheckFlagNotBackSnack =>
      '裝置已回報正常模式，但它另一個狀態旗標還沒回到檢測開始前的值。這通常會在數秒內自行恢復。請等它回來再依賴這顆電容 —— App 沒有送出任何改變它的指令。';
  ...
  @override
  String get settingsAppModeSub => '簡易模式會把「主頁」從底部選單移除，速度偵測與 G 值錶也會一併停用。';

  @override
  String get settingsAppModePersonal => '個人';

  @override
  String get settingsAppModeAdvanced => '簡易';

  @override
  String get settingsDisabledByAdvancedMode => '簡易模式已停用這項功能。切回個人模式即可恢復你原本的設定。';
