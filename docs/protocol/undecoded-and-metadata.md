...
| `0x3A` | ~~capacitor~~ **battery + capacitor** (🔴 corrected 2026-08-09) | 2 | `5100` (capacitor); `0700` (battery) | No hypothesis. Same correction as `0x2C`: §10.2 has listed `0x3A` for batteries since 2026-07-30, and a battery identified by `0x10` = `0x02` in the same session emitted it. |
